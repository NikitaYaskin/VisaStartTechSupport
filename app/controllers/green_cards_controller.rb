class GreenCardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @green_card.save
        ...
        format.json { render :show, status: :created, location: @green_card }
      else
  ...
  def update
    respond_to do |format|
      if @green_card.update(green_card_params)
        ...
        format.json { render :show, status: :ok, location: @green_card }
      else
  ...
  def destroy
    @green_card.destroy
    respond_to do |format|
      format.html { redirect_to green_cards_url, notice: 'Green card was successfully destroyed.' }
