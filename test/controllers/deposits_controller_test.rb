...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { ammount: @deposit.ammount, payer_name: @deposit.payer_name, status: @deposit.status }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { ammount: @deposit.ammount, payer_name: @deposit.payer_name, status: @deposit.status }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
